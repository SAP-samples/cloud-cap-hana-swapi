...
async function init() {
    try {
        ...
        await clearDB(db)
        let people = await readFile('people.json')
        let planets = await readFile('planets.json')
        let films = await readFile('films.json')
        let species = await readFile('species.json')
        let starships = await readFile('starships.json')
        let vehicles = await readFile('vehicles.json')
        let transports = await readFile('transport.json')
